...
<html lang="en">
    <head>
        ...
        <style>
        body {
            background-image: url('perpustakaan.png'); /* Ganti dengan jalur gambar latar belakang Anda */
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <label class="small mb-1">Username</label>
                                                <input class="form-control py-4" id="inputEmail" type="username" required name="username" placeholder="Masukan Username" />
                                        </div>
                                        <div class="form-group">
